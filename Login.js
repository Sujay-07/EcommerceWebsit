                ...
                <div className='card'>
                    ...
                    {/* <div className='card-body'> */}
                        ...
                        <div className='mb-3 mt-3'>
                            <input type='email' value={formValues.username} name='username' 
                            className='border border-1 border-success form-control w-50' placeholder='Enter your username' 
                            onChange={handleChange} required/> 
                        </div>
 
                        <div className='mb-3 mt-3'>
                            <input type='password' value={formValues.password} name='password'
                             className='border border-1 border-success form-control w-50' placeholder='Enter your password' 
                             onChange={handleChange} required/>
                        ...
                        <p className='text-danger'> {loginStatus}</p>
                          ...
                          <p className='text-primary'><a href={`/forgotpass/`}> 
                          Forgot Password? </a> </p>
                        </div>
                </div>
            // </div>
