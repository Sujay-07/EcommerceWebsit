    ...
    <div>
     ...
     <div className='container-fluid bg-light mt-3 p-3'>
        <div className='row'>
            ...
            return(<div className='col-lg-3 mt-2 text-center' key={data.id}>
                <h5> {data.product_name}</h5>
                <p> <img src={`../upload/${data.image}`} alt='not found' 
                width={200} height={200}></img></p>
                <p> ₹ {data.price}/-</p>
                <p><button className='btn btn-warning fw-bold text-dark' 
                style={{width:"110px",fontSize:"18px"}} onClick={() => 
                  AddCart(data.id)}> Add Cart </button>
               
                <button className='btn btn-danger fw-bold text-dark' 
                style={{width:"110px",fontSize:"18px",marginLeft:"10px"}}>
